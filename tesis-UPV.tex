...
\textbf{Fase 7. Prueba en marcha con actuadores.} Prueba de la máquina completa puesta en marcha. La fase no se pudo realizar por problemas externos al proyecto.
...
Este bus es denominado como la \textbf{Respuesta del Módulo Clasificador} o RMC, este módulo contiene los siguientes bloques:% visto en la figura \ref{fig:arqvid} como ''respuesta''.
...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c|c|}
		...
		\multicolumn{1}{|c|}{\multirow{4}{*}{\textbf{Test}}}          & 131             & 394            & 27            \\ \cline{2-4} 
