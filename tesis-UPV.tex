...
\begin{figure}[!tbh]
	...
	\subfloat[Fotografía frontal de maquinaria.]{\includegraphics[width=0.4\linewidth]{ima/altomaqui} \label{front}} \hspace{5mm} %\hfill
	\subfloat[Fotografía de cámara de proceso.]{\includegraphics[width=0.4\linewidth]{ima/cabina} \label{cab}} 
	
	\subfloat[Fotografía lateral izquierdo de maquinaria.]{\includegraphics[width=0.4\linewidth]{ima/ladomaqui}\label{lado1}} \hspace{5mm}%\hfill
	\subfloat[Fotografía lateral derecho de maquinaria.]{\includegraphics[width=0.4\linewidth]{ima/lado2maqui}  \label{lado2}} %\hfill\\
	%}
